...
using Citas.Infrastructure.Factories.Schedules;
...
public static class ServicesSetup
{
  public static IServiceCollection AddCitasServices(this IServiceCollection services)
  {
    ...
    services.AddScoped<IScheduleCreateOneStrategyFactory, ScheduleCreateOneStrategyFactory>();
    ...
    services.AddKeyedScoped<IScheduleCreateOneStrategy, ConcreteScheduleCreateOneAdmin>("admin");
    services.AddKeyedScoped<IScheduleCreateOneStrategy, ConcreteScheduleCreateOneAdmin>("superadmin");
